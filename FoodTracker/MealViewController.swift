...
class MealViewController: UIViewController,
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        // This code safely unwraps the original unedited image from the info dictionary.
        guard let selectedImage = info[UIImagePickerControllerOriginalImage] as?
            UIImage else {
                fatalError("Expected a dictionary containing an image, but was provided the following: \(info)")
        }
        // Set photoViewImage to display the selected image
    ...
    @IBAction func cancel(_ sender: UIBarButtonItem) {
        ...
        // needs to dismiss in one of two different ways.
    ...
    @IBAction func selectImageFromPhotoLibrary(_ sender: UITapGestureRecognizer) {
        ...
        // UIImgePickerController is a view controller that lets a user pick media
